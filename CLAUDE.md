...
This project is indexed by GitNexus as **CLI-Manager** (4954 symbols, 9194 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
