...
This project is indexed by GitNexus as **CLI-Manager** (14012 symbols, 26740 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
