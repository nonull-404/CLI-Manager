...
This project is indexed by GitNexus as **CLI-Manager** (2288 symbols, 3695 relationships, 128 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
