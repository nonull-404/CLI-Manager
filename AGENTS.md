...
This project is indexed by GitNexus as **CLI-Manager** (13875 symbols, 26520 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
