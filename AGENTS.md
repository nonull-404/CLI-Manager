...
This project is indexed by GitNexus as **CLI-Manager** (2445 symbols, 3997 relationships, 144 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
